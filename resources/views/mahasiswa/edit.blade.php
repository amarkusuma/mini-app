        ...
        <div class="form-row">
            <div class="col-lg-6 col-md-6 mb-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" value="{{$mahasiswa->name}}" id="name" placeholder="Name" required>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 mb-2">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control status" name="status_id" id="status" required>
                        ...
                        @foreach ($status as $key => $item)
                            <option id="{{$item->id}}" value="{{ $item->id }}" @if (old('status_id', isset($mahasiswa) ? $mahasiswa->status_id : '') == $item->id) selected @endif  >{{ $item->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control fakultas" name="fakultas_id" id="fakultas" required>
                        ...
                        @foreach ($fakultas as $key => $item)
                            <option id="{{$item->id}}" value="{{ $item->id }}" @if (old('fakultas_id', isset($mahasiswa) ? $mahasiswa->fakultas_id : '') == $item->id) selected @endif>{{ $item->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control jurusan" name="jurusan_id" id="jurusan" required>
                        ...
                        @foreach ($jurusan as $key => $item)
                            <option id="{{$item->id}}" value="{{ $item->id }}" @if (old('jurusan_id', isset($mahasiswa) ? $mahasiswa->jurusan_id : '') == $item->id) selected @endif>{{ $item->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 mb-2">
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" name="address" id="address" placeholder="Address" required rows="3">{{$mahasiswa->address}} </textarea>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 mb-2">
                <div class="form-group">
                    ...
                    <select class="form-control province" name="prov_id" id="province" required>
                        ...
                        @foreach ($province as $key => $item)
                            <option id="{{$item->prov_id}}" value="{{ $item->prov_id }}" @if (old('prov_id', isset($mahasiswa) ? $mahasiswa->prov_id : '') == $item->prov_id) selected @endif >{{ $item->prov_name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 mb-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$mahasiswa->Rt}}" name="Rt" id="Rt" placeholder="Rt" required>
                </div>
            </div>
        </div>
